...
public class GameInfo extends JPanel {
    ...
    private void GenerateActorImage() {
        ...
        int x = (int) (getPreferredSize().getWidth() - 100) / 2;
        ActorHolder.setBounds(x, 10, 100, 100);
...
//        lblBelowSkill.setBorder(BorderFactory.createMatteBorder(2, 2, 2, 2, Color.BLACK));
    ...
    public void HandlingSkill() {
        ...
        System.out.println("In handling skill");
 ...
 /* =============Getters and Setters===============*/
    ...
    public void setDefaultActor() {
        ActorHolder.setIcon(resizeImageIcon(getActorIcon(1), 100, 100));
    }

    public ImageIcon getActorIcon(int version) {
        System.out.println("/img/Actor/" + (color == Red ? "Red" : "Blue") + "Actor" + version + "removebg.png");
