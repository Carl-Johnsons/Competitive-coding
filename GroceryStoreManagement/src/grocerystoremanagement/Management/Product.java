package grocerystoremanagement.Management;
...
public class Product {
    ...
    public void addProduct() throws Exception {
        ...
        while (exit) {
            ...
            if (temp.HSD.compareTo(now) < 0) {
                ...
                System.out.print("Enter Product NSX(dd/MM/yyyy): ");
                temp.NSX = new SimpleDateFormat("dd/MM/yyyy").parse(sc.nextLine());
                ...
                for (int i = 0; i < MyStore.size(); i++) {
                    if ((temp.P_Name.compareTo(MyStore.get(i).P_Name) == 0)
                            ...
                            && (temp.NSX.compareTo(MyStore.get(i).NSX) == 0)) {
    ...
    public String moneyFormatOut(Double moneyOut) {
        StringBuffer Money = new StringBuffer(moneyOut.toString());
